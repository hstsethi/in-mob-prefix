...
def main():
    ...
    parser.add_argument("series", help="Series to predict. Must be a positive 4 digit integer between 6-9")
    ...
    if not series_to_predict.isnumeric() and not len(series_to_predict) == 4:
            raise(ValueError("Series must be an integer and have exactly 4 digits ranging from 6-9"))
